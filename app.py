...
class WatermarkApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setGeometry(100, 100, 750, 600) # Reduced height for better fit
        ...
        self.add_date_checkbox.setChecked(self.add_date_enabled)
    ...
    def _create_widgets(self):
        ...
        text_inputs_layout.addWidget(sender_text_group)
        ...
        text_inputs_layout.addWidget(receiver_text_group)

        text_settings_layout.addLayout(text_inputs_layout)
        ...
        size_label_layout.addWidget(QLabel("Size (%):"))
        ...
        sliders_layout.addWidget(size_group)
        ...
        sliders_layout.addWidget(opacity_group)

        main_layout.addLayout(sliders_layout)

        self.add_date_checkbox = QCheckBox("Add current date")
        self.add_date_checkbox.setChecked(self.add_date_enabled)
        self.add_date_checkbox.stateChanged.connect(self._update_add_date_setting)
        main_layout.addWidget(self.add_date_checkbox)
    ...
    def _update_add_date_setting(self, state):
        self.add_date_enabled = (state == Qt.Checked)
        self._save_settings()
    ...
    def _save_settings(self):
        ...
        with open(config_path, "w") as f:
            ...
            f.write(f"add_date_enabled={self.add_date_enabled}\n")
    ...
    def _load_last_settings(self):
        ...
        if os.path.exists(config_path):
            try:
                ...
                self.add_date_enabled = settings.get("add_date_enabled", "False").lower() == "true"
